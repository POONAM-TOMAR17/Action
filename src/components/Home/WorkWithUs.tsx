    ...
    <section className="w-full lg:h-full flex justify-start items-start flex-wrap">
      <div className="w-full h-full flex justify-center items-start relative">
        ...
        <div className="w-full h-full absolute left-0 top-0">
          <div className="w-full h-full flex justify-start items-center flex-wrap xs:px-4 lg:px-16  lg:mx-auto">
            <div className="xs:w-4/5 left-10 lg:left-24 lg:w-3/5 h-full flex flex-col justify-center items-left relative">
              ...
              <p className=" lg:ml-0 text-md uppercase font-montserrat text-white">
                Working with us
              </p>
              <p className="lg:block font-montserrat text-2xl leading-9 font-bold text-white mt-3 pr-4">
      ...
      <div className="w-full flex justify-start items-center flex-wrap py-4 xs:px-4 lg:px-8 lg:container lg:mx-auto xs:hidden">
