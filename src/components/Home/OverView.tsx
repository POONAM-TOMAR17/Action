  ...
  return (
    <section className="w-full h-full flex justify-between items-center xs:px-4 lg:px-8 lg:mb-5 lg:justify-start lg:container lg:mx-auto">
      <div className="w-full lg:w-4/5 flex justify-start items-start flex-col space-y-4">
        <p className="text-sm uppercase font-montserrat tracking-widest text-customColors-200 mt-6 lg:mt-4">
          Who We Are
        </p>
        <p className="font-medium lg:text-xl xs:text-xl font-montserrat text-customColors-100 tracking-relaxed leading-snug">
