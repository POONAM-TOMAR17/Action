...
const Testimonials = () => {
  ...
  return (
    <section className="w-full h-full flex justify-between items-center xs:px-4 lg:px-8 lg:my-5 lg:justify-start lg:container lg:mx-auto">
      <div className="w-full lg:max-w-5.5xl lg:mx-auto lg:py-10 flex justify-start items-start flex-col">
            ...
            testimonialsList.map((item, index) => (
              <div key={index} className="w-full">
                <div className="w-full flex items-center justify-between py-20">
                  <div className="w-3/5 flex items-center justify-start relative lg:pr-5">
                    <img
                      src="/images/double-quotes.png"
                      alt="double-quotes"
                      className="absolute w-1/3 left-0 z-1"
                      style={{ top: '-80px' }}
                    />
                    <p className="font-light text-lg">“ {item.value} “</p>
                  </div>
                  <div className="w-2/5 flex items-start justify-center lg:pl-5">
