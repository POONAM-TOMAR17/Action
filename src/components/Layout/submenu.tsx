...
export const SubMenu = (props: ISubMenu) => {
  ...
  return (
    <div
      className={`mega-menu w-full relative xs:translate xs:duration-300 lg:absolute lg:inset-x-0 lg:shadow-lg lg:left-0 lg:top-full lg:h-auto${
        subActive ? ' xs:h-auto xs:opacity-100 xs:z-auto' : ' xs:h-0 xs:opacity-0 xs:z-1'
      }`}
    >
